...
function SomeQuestion() {
  return (
    <div className="SomeQuestion">
      <h3
        className=" fs-32-600 text-center mx-auto"
        style={{ maxWidth: "500px" }}
      >
        بعض المساعدات الهامة عند انشاء السيرة الذاتية الخاصة بك
      </h3>
      <div
        className="accordion mt-5 accordion-flush d-flex flex-column gap-3"
