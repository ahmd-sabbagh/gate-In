...
// Number List Option
function CourseFilterComponents({ api, JobClassification, setData }) {
  ...
  const OnSubmit = async (e) => {
    ...
    try {
      const { data } = await axios.post(`${basedUrl}${api}`, formData, {
        headers: {
  ...
  const getAds = () => {
    axios
      .post(`${basedUrl}/public/data/ads`, { page: "course", apiHeaders })
      .then(({ data }) => {
        setAds(data.data);
      })
      .catch((error) => {
        ...
        <div className="border bg-white custom">
          <form onSubmit={OnSubmit}>
            <div className="head d-flex justify-content-between border-bottom align-items-center">
              <h4 className="fs-20-500">{trans("filter.course_filter")}</h4>
              <button
                type="submit"
              ...
              >
                ...
                >
                  <h5 className="fs-16-500">
                    {trans("filter.course_classification")}
                  </h5>
            ...
            >
              ...
              >
                <h5 className="fs-16-500">
                  {trans("filter.Type_of_the_course")}
                </h5>
            ...
            >
              ...
              >
                <h5 className="fs-16-500">
                  {trans("filter.course_posting_date")}
                </h5>
